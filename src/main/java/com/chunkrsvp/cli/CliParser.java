...
public class CliParser {
    public static CliArguments parse(String[] args) {
        ...
        boolean help = false, init = false, noControls = false;
        ...
        for (String arg : args) {
            ...
            else if (arg.equals("--no-controls")) { noControls = true; }
        ...
        return new CliArguments(wpm, sm, pm, sd, pd, help, init, filePath, noControls);
    }
}
